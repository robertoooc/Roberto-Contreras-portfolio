    ...
    return(
        <div> {console.log('plz hire me 🙏')}
            ...
            <div className='mb-5 text-lg'>
                ...
                <div className='mx-auto w-fit bg-white rounded-md mt-5'>
                    <a className='flex mx-3' href='/RobertoContrerasResume.pdf' target='_blank'>
            ...
            <div className="flex justify-center space-x-5 bg-[rgb(32,32,32)] mt-10">
                ...
                <a href='https://github.com/robertoooc' target='_blank' className='bg-white rounded-full my-5'><VscGithubInverted size={25} className='place-self-center m-2'/></a>
